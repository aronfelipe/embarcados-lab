...
// TC
#define LED_PIO_TC PIOA
#define LED_PIO_TC_ID ID_PIOA
#define LED_IDX_TC 0
#define LED_IDX_TC_MASK (1 << LED_IDX_TC)

// RTT
#define LED_PIO_RTT       PIOC
#define LED_PIO_RTT_ID    ID_PIOC
#define LED_IDX_RTT       30
#define LED_IDX_RTT_MASK  (1u << LED_IDX_RTT)
